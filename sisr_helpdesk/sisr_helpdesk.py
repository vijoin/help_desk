...
class sisr_helpdesk_incidencia(osv.osv):
    ...
    _columns = {
        'fecha_creacion': fields.date('Fecha de Creación', help="Fecha de Creación de la Incidencia"),
    ...
    _defaults = {
        'codigo': lambda self,cr,uid,context={}: self.pool.get('ir.sequence').get(cr, uid, 'sisr.helpdesk.incidencia'),
