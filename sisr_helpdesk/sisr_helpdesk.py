...
class sisr_helpdesk_incidencia(osv.osv):
    ...
    'forma_de_solicitud':fields.selection([('memo','Memo'),('correo','Correo Electrónico'),('llamada','Llamada Telefónica'),('presencial','Presencial'), ('gestion','Gestión de Documental')], string="Forma de Solicitud"),
